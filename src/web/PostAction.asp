...
PostAction.prototype.getIdParam = function() {
	if (this.input.id) {
		try {
...
PostAction.prototype.withStringParam = function(name, value, minLength, maxLength, matchs) {
...
PostAction.prototype.getIdsParam = function() {
