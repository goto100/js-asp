...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:page="huan:page">
	...
	<xsl:template match="/" mode="alert">
		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			<head>
				<link type="text/css" rel="stylesheet" href="{$rootPath}skins/default/styles/{$system.setting/defaultStyle}/common.css" />
				<script type="text/javascript" src="{$rootPath}skins/default/script/common.js"></script>
			...
			<body class="alert">
				<div id="Wrapper">
					<div id="InnerWrapper">
						<div id="Header">
							<p id="logo"><a href="{$rootPath}."><img src="{$rootPath}skins/default/template/images/logo.png" alt="返回首页" /></a></p>
