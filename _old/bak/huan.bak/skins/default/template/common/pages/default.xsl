...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:page="huan:page">
	...
	<xsl:template match="/" mode="default">
		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			<head>
				<link type="text/css" rel="stylesheet" href="{$rootPath}skins/{$system.setting/defaultSkin}/styles/{$system.setting/defaultStyle}/common.css" />
				<script type="text/javascript" src="{$rootPath}skins/{$system.setting/defaultSkin}/script/common.js"></script>
				<xsl:if test="$script">
					<script type="text/javascript" src="{$rootPath}skins/{$system.setting/defaultSkin}/script/{$script}"></script>
				</xsl:if>
			...
			<body class="default">
				<div id="Wrapper">
					<div id="InnerWrapper">
						<div id="Header">
							<p id="logo"><a href="{$rootPath}."><img src="{$rootPath}skins/{$system.setting/defaultSkin}/template/images/logo.png" alt="返回首页" /></a></p>
