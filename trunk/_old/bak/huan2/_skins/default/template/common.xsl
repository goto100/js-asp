...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:variable name="system.setting" select="document('../../../_cache/setting.xml')/setting" />
	<xsl:variable name="system.userGroups" select="document('../../../_cache/userGroups.xml')/userGroups" />
	<xsl:variable name="system.category" select="document('../../../_cache/category.xml')/category" />
